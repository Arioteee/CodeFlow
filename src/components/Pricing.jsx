		...
		<section id='pricing' className='relative py-16 sm:py-20 px-10 sm:px-6 lg:px-8'>
			<div className='max-w-7xl mx-auto'>
				<div className='text-center mb-12 sm:mb-16 lg:mb-20'>
					...
					<p className='text-gray-400 text-base md:text-xl sm:text-lg max-w-2xl mx-auto'>
						...
						>
							...
							<ul className='space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row'>
								{plan.features.map((feature, featureKey) => (
									...
									>
										<div className='flex items-center justify-center shrink-0 mt-0.5 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-blue-500/20'>
